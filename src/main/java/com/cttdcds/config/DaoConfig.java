...
@MapperScan("com.cttdcds.mapper")
@EnableTransactionManagement
public class DaoConfig {

    @Value("${cttdcds.jdbc.driver}")
    private String driverClassName;

    @Value("${cttdcds.jdbc.url}")
    private String url;

    @Value("${cttdcds.jdbc.username}")
    private String username;

    @Value("${cttdcds.jdbc.password}")
    private String password;

    @Value("com.cttdcds.pojo")
